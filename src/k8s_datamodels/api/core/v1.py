...
class StorageOSPersistentVolumeSourceModel(BaseModel):
    ...
    secretRef: Optional[ObjectReferenceModel2] = Field(
        None,
        description='secretRef specifies the secret to use for obtaining the StorageOS API credentials.  If not specified, default values will be attempted.',
    )
    volumeName: Optional[str] = Field(
...
class PersistentVolumeClaimCondition(BaseModel):
    lastProbeTime: Optional[v1.TimeModel6] = Field(
...
class ContainerStateTerminated(BaseModel):
    ...
    finishedAt: Optional[v1.TimeModel18] = Field(
...
class EndpointAddress(BaseModel):
    ...
    targetRef: Optional[ObjectReferenceModel2] = Field(
...
class LimitRangeItem(BaseModel):
    ...
    defaultRequest: Optional[Dict[str, resource.QuantityModel5]] = Field(
        None,
        description='DefaultRequest is the default resource requirement request value by resource name if resource request is omitted.',
    )
    max: Optional[Dict[str, resource.QuantityModel5]] = Field(
        None, description='Max usage constraints on this kind by resource name.'
    )
    maxLimitRequestRatio: Optional[Dict[str, resource.QuantityModel5]] = Field(
        None,
        description='MaxLimitRequestRatio if specified, the named resource must have a request and limit that are both non-zero where limit divided by request is less than or equal to the enumerated value; this represents the max burst for the named resource.',
    )
    min: Optional[Dict[str, resource.QuantityModel5]] = Field(
...
class NamespaceCondition(BaseModel):
    lastTransitionTime: Optional[v1.TimeModel18] = {}
...
class NodeCondition(BaseModel):
    lastHeartbeatTime: Optional[v1.TimeModel18] = Field(
...
class NodeStatus(BaseModel):
    ...
    allocatable: Optional[Dict[str, resource.QuantityModel5]] = Field(
        None,
        description='Allocatable represents the resources of a node that are available for scheduling. Defaults to Capacity.',
    )
    capacity: Optional[Dict[str, resource.QuantityModel5]] = Field(
        None,
...
class PersistentVolumeClaimStatusModel(BaseModel):
    ...
    allocatedResources: Optional[Dict[str, resource.QuantityModel5]] = Field(
        None,
        description='allocatedResources is the storage resource within AllocatedResources tracks the capacity allocated to a PVC. It may be larger than the actual capacity when a volume expansion operation is requested. For storage quota, the larger value from allocatedResources and PVC.spec.resources is used. If allocatedResources is not set, PVC.spec.resources alone is used for quota calculation. If a volume expansion capacity request is lowered, allocatedResources is only lowered if there are no expansion operations in progress and if the actual volume capacity is equal or lower than the requested capacity. This is an alpha field and requires enabling RecoverVolumeExpansionFailure feature.',
    )
    capacity: Optional[Dict[str, resource.QuantityModel5]] = Field(
...
class ResourceQuotaStatus(BaseModel):
    ...
    used: Optional[Dict[str, resource.QuantityModel5]] = Field(
        None,
...
class ServicePort(BaseModel):
    ...
    targetPort: Optional[intstr.IntOrStringModel2] = Field(
        {},
...
class Taint(BaseModel):
    ...
    timeAdded: Optional[v1.TimeModel18] = Field(
        None,
...
class ResourceFieldSelectorModel1(BaseModel):
    ...
    divisor: Optional[resource.QuantityModel6] = Field(
        {},
        description='Specifies the output format of the exposed resources, defaults to "1"',
    )
    resource: str = Field(..., description='Required: resource to select')
...
class PodAffinityTerm(BaseModel):
    ...
    namespaceSelector: Optional[v1.LabelSelectorModel3] = Field(
        None,
...
class PersistentVolumeSpec(BaseModel):
    ...
    capacity: Optional[Dict[str, resource.QuantityModel4]] = Field(
        None,
...
class Binding(BaseModel):
    ...
    target: ObjectReferenceModel2 = Field(
        ...,
...
class Event(BaseModel):
    ...
    eventTime: Optional[v1.MicroTimeModel] = Field(
        {}, description='Time when this Event was first observed.'
    )
    firstTimestamp: Optional[v1.TimeModel18] = Field(
        {},
        description='The time at which the event was first recorded. (Time of server receipt is in TypeMeta.)',
    )
    involvedObject: ObjectReferenceModel2 = Field(
    ...
    lastTimestamp: Optional[v1.TimeModel18] = Field(
        {},
    ...
    related: Optional[ObjectReferenceModel2] = Field(
...
class PersistentVolumeSpecModel(BaseModel):
    ...
    claimRef: Optional[ObjectReferenceModel2] = Field(
        None,
        description='claimRef is part of a bi-directional binding between PersistentVolume and PersistentVolumeClaim. Expected to be non-nil when bound. claim.VolumeName is the authoritative bind between PV and PVC. More info: https://kubernetes.io/docs/concepts/storage/persistent-volumes#binding',
    )
...
class PodStatus(BaseModel):
    ...
    startTime: Optional[v1.TimeModel18] = Field(
        None,
...
class ServiceAccount(BaseModel):
    ...
    secrets: Optional[List[ObjectReferenceModel2]] = Field(
        None,
...
class ServiceStatus(BaseModel):
    ...
    loadBalancer: Optional[LoadBalancerStatusModel] = Field(
        {},
...
class PersistentVolumeClaimSpecModel1(BaseModel):
    ...
    selector: Optional[v1.LabelSelectorModel9] = Field(
        None,
        description='selector is a label query over volumes to consider for binding.',
    )
    storageClassName: Optional[str] = Field(
...
class PodAffinityTermModel1(BaseModel):
    ...
    namespaceSelector: Optional[v1.LabelSelectorModel9] = Field(
        None,
        description='A label query over the set of namespaces that the term applies to. The term is applied to the union of the namespaces selected by this field and the ones listed in the namespaces field. null selector and null or empty namespaces list means "this pod\'s namespace". An empty selector ({}) matches all namespaces.',
    )
    namespaces: Optional[List[str]] = Field(
