...
from k8s_datamodels.io.k8s.apimachinery.pkg.apis.meta import v1 as v1_1
from ..core import v1
...
class CronJobStatus(BaseModel):
    ...
    lastSuccessfulTime: Optional[v1_1.Time] = Field(
        None,
...
class JobStatus(BaseModel):
    ...
    completionTime: Optional[v1_1.Time] = Field(
        None,
