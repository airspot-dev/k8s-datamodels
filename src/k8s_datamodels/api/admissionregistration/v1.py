...
class MutatingWebhook(BaseModel):
    ...
    namespaceSelector: Optional[v1.LabelSelectorModel4] = Field(
        None,
    ...
    objectSelector: Optional[v1.LabelSelectorModel4] = Field(
        None,
...
class MutatingWebhookConfiguration(BaseModel):
    ...
    metadata: Optional[v1.ObjectMetaModel7] = Field(
        {},
